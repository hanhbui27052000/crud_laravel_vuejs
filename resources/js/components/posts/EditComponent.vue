...
<script>
    export default {
        ...
        created(){
            this.axios.get(`http://localhost:8000/api/admin/post/${this.$route.params.id}/edit`)
            .then(response => {
        ...
        methods : { 
            updatePost(){
                this.axios.patch(`http://localhost:8000/api/admin/post/${this.$route.params.id}`,this.post)
